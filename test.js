...
(async function (){
    try {
        //const { Stops}  = await vgn.getStops('Plärrer', {limit: 10});
        //const Output = await vgn.getStopsbygps('49.45015694', '11.083455', {limit: 2, distance: 400, sort: 'Distance'});
        const Output = await vgn.getDepartures(704, {product: "Ubahn", timespan: 60, timedelay: 0, limitlount: 5})
        ...
        //const Output = await vgn.getTrip(1000917, {product: "Ubahn"})
